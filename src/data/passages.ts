...
const source = "Reina-Valera 1909, dominio público";
...
export const passages: Passage[] = [
  ...
  },
  {
    ...
    text: "8 No debáis á nadie nada, sino amaros unos á otros; porque el que ama al prójimo, cumplió la ley. 9 Porque: No adulterarás; no matarás; no hurtarás; no dirás falso testimonio; no codiciarás; y si hay algún otro mandamiento, en esta sentencia se comprende sumariamente: Amarás á tu prójimo como á ti mismo. 10 La caridad no hace mal al prójimo: así que, el cumplimento de la ley es la caridad.",
    context:
      "El centro del pasaje es simple y exigente: el amor se vuelve una práctica concreta hacia el prójimo.",
    source,
  },
  {
    ...
    themes: ["paz", "ansiedad", "gratitud"],
    text: "6 Por nada estéis afanosos; sino sean notorias vuestras peticiones delante de Dios en toda oración y ruego, con hacimiento de gracias. 7 Y la paz de Dios, que sobrepuja todo entendimiento, guardará vuestros corazones y vuestros entendimientos en Cristo Jesús.",
    context:
      "Estas líneas aparecen como una invitación a traer la inquietud a la oración, no a fingir que no existe.",
    source,
  },
  {
    id: "matthew-6-25-34",
    ...
    context:
      "Dentro del sermón del monte, Jesús habla a una preocupación humana muy concreta: el peso de anticipar el mañana.",
    source,
  },
  {
    id: "proverbs-4-20-27",
  ...
  },
  {
    ...
    chapter: 34,
    verses: "4-8",
    reference: "Salmos 34:4-8",
    themes: ["temor", "soledad", "paz"],
    text: "4 Busqué á Jehová, y él me oyó, y libróme de todos mis temores. 5 A él miraron y fueron alumbrados: y sus rostros no se avergonzaron. 6 Este pobre clamó, y oyóle Jehová, y librólo de todas sus angustias. 7 El ángel de Jehová acampa en derredor de los que le temen, y los defiende. 8 Gustad, y ved que es bueno Jehová: dichoso el hombre que confiará en él.",
    context:
      "El salmo recuerda una experiencia de angustia convertida en testimonio: buscar, clamar y ser sostenido.",
    source,
  },
  {
    id: "psalm-51-10-12",
    ...
    themes: ["perdon", "fe"],
    text: "10 Crea en mí, oh Dios, un corazón limpio; y renueva un espíritu recto dentro de mí. 11 No me eches de delante de ti; y no quites de mí tu santo espíritu. 12 Vuélveme el gozo de tu salud; y el espíritu libre me sustente.",
    context:
      "Esta oración no minimiza la culpa; la lleva a Dios como deseo de renovación interior.",
    source,
  },
  {
    id: "first-thessalonians-5-16-18",
    ...
    context:
      "Al cerrar la carta, Pablo condensa una vida espiritual sencilla: gozo, oración y gratitud sostenida.",
    source,
  },
  {
    id: "romans-8-31-39",
  ...
  },
  {
    ...
    chapter: 14,
    verses: "1-6",
    reference: "Juan 14:1-6",
    themes: ["esperanza", "proposito", "paz"],
    ...
    context:
      "Jesús habla a discípulos inquietos y dirige su mirada hacia una esperanza personal y relacional.",
    source,
  },
  {
    id: "joshua-1-8-9",
    ...
    context:
      "En el inicio de una etapa nueva, la valentía aparece unida a la meditación y a la presencia de Dios.",
    source,
  },
  {
    id: "matthew-11-28-30",
    ...
    themes: ["paz", "soledad", "ansiedad"],
    text: "28 Venid á mí todos los que estáis trabajados y cargados, que yo os haré descansar. 29 Llevad mi yugo sobre vosotros, y aprended de mí, que soy manso y humilde de corazón; y hallaréis descanso para vuestras almas. 30 Porque mi yugo es fácil, y ligera mi carga.",
    context:
      "El pasaje invita al descanso no como escape, sino como aprendizaje de un ritmo distinto.",
    source,
  },
  {
    id: "first-corinthians-13-4-8",
    book: "1 Corintios",
    chapter: 13,
    verses: "4-8",
    reference: "1 Corintios 13:4-8",
    themes: ["amor", "gratitud"],
    ...
    context:
      "Pablo describe el amor como una forma paciente de permanecer, más que como un sentimiento pasajero.",
    source,
  },
];

export function findPassageById(id: string) {
  return passages.find((passage) => passage.id === id) ?? passages[0];
}

export function findPassagesByTheme(theme: ThemeKey) {
  return passages.filter((passage) => passage.themes.includes(theme));
}

export function getPassageForTheme(theme: ThemeKey) {
  return findPassagesByTheme(theme)[0] ?? passages[0];
}
